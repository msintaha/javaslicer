...
public class UntracedArrayList<E> implements List<E> {
    ...
    /**
     * Trims the capacity of this <code>ArrayList</code> instance to be the list's current size. An application can use
     * this operation to minimize the storage of an <code>ArrayList</code> instance.
     */
    ...
    /**
     * Increases the capacity of this <code>ArrayList</code> instance, if necessary, to ensure that it can hold at least
     ...
     * and only if this list contains at least one element <code>e</code> such that
     ...
     * contain the element. More formally, returns the lowest index <code>i</code> such that
     ...
     * contain the element. More formally, returns the highest index <code>i</code> such that
     * <code>(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o.equals(get(i)))</code>, or -1 if there is no such index.
     */
    @Override
     ...
     * element in the array immediately following the end of the collection is set to <code>null</code>. (This is useful
     ...
     * contain the element, it is unchanged. More formally, removes the element with the lowest index <code>i</code> such
     * that <code>(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o.equals(get(i)))</code> (if such an element exists).
     * Returns <code>true</code> if this list contained the specified element (or equivalently, if this list changed as a
     * result of the call).
     *
     * @param o
